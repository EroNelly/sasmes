...
<div class="sidebar">
    <div class="ref">
        ...
        <a href="../dashboard.php" styl>Dashboard</a>
        <a id="acc" href="../accManage/index.php">Account Management</a>
        <a id="masterlist" href="">MasterList</a>
        <a class="active" id="service" href="">Service Management</a>
...
<div class="header">
        <div class="topC">
          <div><h3>Services Management</h3></div>
...
<div class="content">
  ...
  <hr>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">Service No.</th>
			...
			$get_data = "SELECT services.*,offices.officeName, unit.unit FROM services
			INNER JOIN unit on services.unitID = unit.unitID
            INNER JOIN offices on unit.officeID = offices.officeID" ;
...
<input type="text" class="form-control" name="serviceName" placeholder="Enter serviceName" required>
</div>
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<select id="unit" name="unit" class="form-control">
  <option selected value='1'>Guidance and Counseling Unit</option>
  <option value='2'>Student and Welfare Service Unit</option>
  <option value='3'>Foundation and Discipline</option>
</select>
</div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>serviceName:</strong>$serviceName<br>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<input type='text' class='form-control' name='serviceName' placeholder='Enter your serviceName' value='$serviceName' required>
		</div>
